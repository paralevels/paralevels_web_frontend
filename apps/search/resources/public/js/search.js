...
"undefined"!==typeof console&&(l=function(){return console.log.apply(console,e.call(null,arguments))},m=function(){return console.error.apply(console,e.call(null,arguments))});if("undefined"===typeof f||"undefined"===typeof g||"undefined"===typeof t)var t=function(){throw Error("cljs.core/*eval* not bound");};function u(){return alert("Hello from ClojureScript Test 5!")}var v=["search","greet"],w=b;v[0]in w||"undefined"==typeof w.execScript||w.execScript("var "+v[0]);for(var x;v.length&&(x=v.shift());)v.length||void 0===u?w=w[x]&&w[x]!==Object.prototype[x]?w[x]:w[x]={}:w[x]=u;
})();
